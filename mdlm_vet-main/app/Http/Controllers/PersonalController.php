...
class PersonalController extends Controller
{
    ...
    {
        $personal = $this->personalService->getAll(['with' => ['user']]);

        return response()->json(PersonalResource::collection($personal)->response()->getData(true));
    }
    ...
    public function store(StorePersonalRequest $request): JsonResponse
    {
        ...
        return response()->json(new PersonalResource($personal->load('user')), 201);
    }
    ...
    {
        $personal = $this->personalService->getById($id);
        $personal->load('user');
    ...
    public function update(UpdatePersonalRequest $request, string $id): JsonResponse
    {
        ...
        return response()->json(new PersonalResource($personal->load('user')));
    }
