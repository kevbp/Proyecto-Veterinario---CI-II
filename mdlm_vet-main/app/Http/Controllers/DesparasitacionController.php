...
class DesparasitacionController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        return response()->json(DesparasitacionResource::collection($desparasitaciones));
    }
    ...
    public function store(StoreDesparasitacionRequest $request): JsonResponse
    {
        ...
        return response()->json(new DesparasitacionResource($desparasitacion), 201);
    }
    ...
    public function show(string $id): JsonResponse
    {
        ...
        return response()->json(new DesparasitacionResource($desparasitacion));
    }
