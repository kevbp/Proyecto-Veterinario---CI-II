...
use App\Http\Resources\VacunaAnimalResource;
...
class VacunaAnimalController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        return response()->json(VacunaAnimalResource::collection($vacunas)->response()->getData(true));
    }
    ...
    public function store(StoreVacunaAnimalRequest $request): JsonResponse
    {
        ...
        return response()->json(new VacunaAnimalResource($vacuna), 201);
    }
    ...
    public function show(string $id): JsonResponse
    {
        ...
        return response()->json(new VacunaAnimalResource($vacuna));
    }
