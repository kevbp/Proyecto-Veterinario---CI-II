...
#[OA\Schema(
    ...
    description: 'Request para actualizar los datos de una campaña existente',
    properties: [
        new OA\Property(property: 'nombre', type: 'string', example: 'Campaña Antirrábica 2026 - Edición Extendida'),
        new OA\Property(property: 'descripcion', type: 'string', example: 'Vacunación masiva gratuita extendida a zonas aledañas.'),
        new OA\Property(property: 'lugar', type: 'string', example: 'Plaza de Armas SJM y Parque Zonal'),
        new OA\Property(property: 'fecha_hora_inicio', type: 'string', format: 'date-time', example: '2026-05-01 09:00:00'),
        new OA\Property(property: 'fecha_hora_fin', type: 'string', format: 'date-time', example: '2026-05-05 17:00:00'),
