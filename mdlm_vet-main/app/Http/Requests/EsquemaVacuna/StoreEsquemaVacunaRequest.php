...
#[OA\Schema(
    schema: 'StoreEsquemaVacunaRequest',
    title: 'StoreEsquemaVacunaRequest',
    description: 'Request para crear un esquema de vacuna',
...
class StoreEsquemaVacunaRequest extends FormRequest
{
    ...
    {
        return [
            'codigo' => 'required|string|max:20|unique:esquema_vacunas,codigo',
