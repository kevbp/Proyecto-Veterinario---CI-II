...
use App\Http\Controllers\CatalogoAlergiasController;
use App\Http\Controllers\CatalogoCondicionesController;
...
Route::prefix('auth')->middleware('auth:api')->group(function () {
    ...
    Route::get('perfil-prueba', [AuthController::class, 'perfilPrueba']);
    Route::get('debug-permisos', [AuthController::class, 'debugPermisos']);
});
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('propietarios/{id}/direccion', [PropietarioController::class, 'obtenerDireccion'])->middleware('permission:ver propietarios');
    ...
    Route::patch('animales/{animal}/fallecimiento', [AnimalController::class, 'registrarFallecimiento'])->middleware('permission:editar mascotas');
    ...
    // --- Tablas maestras (lectura para autenticados, escritura para roles administrativos) ---
    Route::get('raza/especie/{codigo}', [RazaController::class, 'getEspecieByCodigo']);
    Route::get('raza', [RazaController::class, 'index']);
    Route::get('raza/{raza}', [RazaController::class, 'show']);
    Route::post('raza', [RazaController::class, 'store'])->middleware('permission:crear razas');
    Route::put('raza/{raza}', [RazaController::class, 'update'])->middleware('permission:editar razas');
    Route::delete('raza/{raza}', [RazaController::class, 'destroy'])->middleware('permission:eliminar razas');

    Route::get('esquema-vacunas', [EsquemaVacunaController::class, 'index']);
    Route::get('esquema-vacunas/{esquema_vacuna}', [EsquemaVacunaController::class, 'show']);
    Route::post('esquema-vacunas', [EsquemaVacunaController::class, 'store'])->middleware('permission:crear vacunas');
    Route::put('esquema-vacunas/{esquema_vacuna}', [EsquemaVacunaController::class, 'update'])->middleware('permission:editar vacunas');
    Route::delete('esquema-vacunas/{esquema_vacuna}', [EsquemaVacunaController::class, 'destroy'])->middleware('permission:eliminar vacunas');

    Route::get('especies', [EspecieController::class, 'index']);
    Route::get('especies/{especie}', [EspecieController::class, 'show']);
    Route::post('especies', [EspecieController::class, 'store'])->middleware('permission:crear especies');
    Route::put('especies/{especie}', [EspecieController::class, 'update'])->middleware('permission:editar especies');
    Route::delete('especies/{especie}', [EspecieController::class, 'destroy'])->middleware('permission:eliminar especies');

    Route::get('tipo-documentos', [TipoDocumentoController::class, 'index']);
    Route::get('estado-citas', [EstadoCitaController::class, 'index']);

    // --- Adopciones ---
    Route::get('adopciones', [AdopcionController::class, 'index'])->middleware('permission:ver mascotas');
    ...
    Route::get('adopciones/estadisticas-adopcion-por-fechas', [AdopcionController::class, 'estadisticasAdopcionFechas'])->middleware('permission:ver mascotas');
    ...
    // --- Catalogo de condiciones y alergias ---
    Route::apiResource('condiciones', CatalogoCondicionesController::class)->only(['index', 'show'])->middleware('permission:ver condiciones');
    Route::apiResource('condiciones', CatalogoCondicionesController::class)->only(['store'])->middleware('permission:crear condiciones');
    Route::apiResource('condiciones', CatalogoCondicionesController::class)->only(['update'])->middleware('permission:editar condiciones');
    Route::apiResource('condiciones', CatalogoCondicionesController::class)->only(['destroy'])->middleware('permission:eliminar condiciones');

    Route::apiResource('alergias', CatalogoAlergiasController::class)->only(['index', 'show'])->middleware('permission:ver alergias');
    Route::apiResource('alergias', CatalogoAlergiasController::class)->only(['store'])->middleware('permission:crear alergias');
    Route::apiResource('alergias', CatalogoAlergiasController::class)->only(['update'])->middleware('permission:editar alergias');
    Route::apiResource('alergias', CatalogoAlergiasController::class)->only(['destroy'])->middleware('permission:eliminar alergias');

    // --- Condiciones y Alergias de Animales ---
    Route::apiResource('animales/{id}/condiciones', AnimalCondicionController::class)->only(['index', 'show'])->middleware('permission:ver condiciones');
    Route::apiResource('animales/{id}/condiciones', AnimalCondicionController::class)->only(['store'])->middleware('permission:crear condiciones');
    Route::apiResource('animales/{id}/condiciones', AnimalCondicionController::class)->only(['update'])->middleware('permission:editar condiciones');
    Route::apiResource('animales/{id}/condiciones', AnimalCondicionController::class)->only(['destroy'])->middleware('permission:eliminar condiciones');

    Route::apiResource('animales/{id}/alergias', AnimalAlergiaController::class)->only(['index', 'show'])->middleware('permission:ver alergias');
    Route::apiResource('animales/{id}/alergias', AnimalAlergiaController::class)->only(['store'])->middleware('permission:crear alergias');
    Route::apiResource('animales/{id}/alergias', AnimalAlergiaController::class)->only(['update'])->middleware('permission:editar alergias');
    Route::apiResource('animales/{id}/alergias', AnimalAlergiaController::class)->only(['destroy'])->middleware('permission:eliminar alergias');
