...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permisos = [
            ...
            'crear catalogo-condiciones', 'editar catalogo-condiciones', 'eliminar catalogo-condiciones', 'ver catalogo-condiciones',
            'crear catalogo-alergias', 'editar catalogo-alergias', 'eliminar catalogo-alergias', 'ver catalogo-alergias',
        ...
        $gestorRole->syncPermissions([
            ...
            'ver catalogo-condiciones', 'crear catalogo-condiciones', 'editar catalogo-condiciones', 'eliminar catalogo-condiciones',
            'ver catalogo-alergias', 'crear catalogo-alergias', 'editar catalogo-alergias', 'eliminar catalogo-alergias',
        ...
        $recepcionistaRole->syncPermissions([
            ...
            'ver catalogo-alergias',
            'ver catalogo-condiciones',
            'ver examenes',
            'ver resultados',
            'ver campanias',
        ]);
        $veterinarioRole->syncPermissions([
            ...
            'ver condiciones', 'crear condiciones', 'editar condiciones', 'eliminar condiciones',
            'ver alergias', 'crear alergias', 'editar alergias', 'eliminar alergias',
            'ver catalogo-alergias', 'crear catalogo-alergias', 'editar catalogo-alergias',
            'ver catalogo-condiciones', 'crear catalogo-condiciones', 'editar catalogo-condiciones',
            'ver examenes', 'crear examenes', 'editar examenes', 'eliminar examenes',
            'ver resultados', 'crear resultados', 'editar resultados', 'eliminar resultados',
            'ver campanias',
        ]);
