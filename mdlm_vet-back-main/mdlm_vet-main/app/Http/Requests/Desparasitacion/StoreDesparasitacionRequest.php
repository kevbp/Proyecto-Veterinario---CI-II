...
#[OA\Schema(
    schema: 'StoreDesparasitacionRequest',
    required: ['medicamento_id', 'fecha_aplicacion', 'fecha_aplicacion_sgte', 'dosis', 'via', 'personal_id'],
    properties: [
...
class StoreDesparasitacionRequest extends FormRequest
{
    ...
    {
        return [
            'animal_id' => 'nullable|required_without:consulta_id|exists:animals,id',
