...
class StoreVacunaAnimalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'esquema_vacuna_id' => 'nullable|required|exists:esquema_vacunas,codigo',
            ...
            'campania_id' => [
                'nullable',
                'uuid',
                Rule::exists('campanias', 'id')->where(function ($query) {$query->where('estado', EstadoCampania::EN_CURSO->value);}
            )],
        ];
    }
